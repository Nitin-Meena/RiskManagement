/* checksum : 0b3abada92b7c2bf3b640dd9022a5225 */
@cds.external : true
@m.IsDefaultEntityContainer : 'true'
@sap.message.scope.supported : 'true'
@sap.supported.formats : 'atom json xlsx'
service buspart_apihub {};

@cds.external : true
@cds.persistence.skip : true
@sap.content.version : '1'
@sap.label : 'Email Address'
entity buspart_apihub.A_AddressEmailAddress {
...
entity buspart_apihub.A_AddressFaxNumber {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Address Number'
  key AddressID : String(10) not null;
  @sap.display.format : 'UpperCase'
...
entity buspart_apihub.A_AddressHomePageURL {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Address Number'
  key AddressID : String(10) not null;
  @sap.display.format : 'UpperCase'
...
entity buspart_apihub.A_AddressPhoneNumber {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Address Number'
  key AddressID : String(10) not null;
  @sap.display.format : 'UpperCase'
...
entity buspart_apihub.A_BPAddrDepdntIntlLocNumber {
  @sap.display.format : 'UpperCase'
...
entity buspart_apihub.A_BPAddressIndependentEmail {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
entity buspart_apihub.A_BPAddressIndependentFax {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
entity buspart_apihub.A_BPAddressIndependentMobile {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
entity buspart_apihub.A_BPAddressIndependentPhone {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
entity buspart_apihub.A_BPAddressIndependentWebsite {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
entity buspart_apihub.A_BPContactToAddress {
  @sap.display.format : 'UpperCase'
  ...
  to_EmailAddress : Association to many buspart_apihub.A_AddressEmailAddress {  };
  to_FaxNumber : Association to many buspart_apihub.A_AddressFaxNumber {  };
  to_MobilePhoneNumber : Association to many buspart_apihub.A_AddressPhoneNumber {  };
  to_PhoneNumber : Association to many buspart_apihub.A_AddressPhoneNumber {  };
  to_URLAddress : Association to many buspart_apihub.A_AddressHomePageURL {  };
};
...
entity buspart_apihub.A_BPContactToFuncAndDept {
  @sap.display.format : 'UpperCase'
  @sap.label : 'BP Relationship No.'
  @sap.quickinfo : 'BP Relationship Number'
  key RelationshipNumber : String(12) not null;
...
entity buspart_apihub.A_BPCreditWorthiness {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
entity buspart_apihub.A_BPDataController {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
entity buspart_apihub.A_BPEmployment {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
entity buspart_apihub.A_BPFinancialServicesExtn {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
entity buspart_apihub.A_BPFinancialServicesReporting {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
entity buspart_apihub.A_BPFiscalYearInformation {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
entity buspart_apihub.A_BPIntlAddressVersion {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
entity buspart_apihub.A_BPRelationship {
  @sap.display.format : 'UpperCase'
  @sap.label : 'BP Relationship No.'
  @sap.quickinfo : 'BP Relationship Number'
  key RelationshipNumber : String(12) not null;
...
entity buspart_apihub.A_BuPaAddressUsage {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
entity buspart_apihub.A_BuPaIdentification {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
@sap.content.version : '1'
@sap.label : 'Industry'
entity buspart_apihub.A_BuPaIndustry {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Industry'
...
@sap.content.version : '1'
@sap.label : 'Business Partner'
entity buspart_apihub.A_BusinessPartner {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
  ...
  @sap.quickinfo : 'Company ID of Trading Partner'
  TradingPartner : String(6);
  to_AddressIndependentEmail : Association to many buspart_apihub.A_BPAddressIndependentEmail {  };
  to_AddressIndependentFax : Association to many buspart_apihub.A_BPAddressIndependentFax {  };
  to_AddressIndependentMobile : Association to many buspart_apihub.A_BPAddressIndependentMobile {  };
  to_AddressIndependentPhone : Association to many buspart_apihub.A_BPAddressIndependentPhone {  };
  to_AddressIndependentWebsite : Association to many buspart_apihub.A_BPAddressIndependentWebsite {  };
  to_BPCreditWorthiness : Association to buspart_apihub.A_BPCreditWorthiness {  };
  to_BPDataController : Association to many buspart_apihub.A_BPDataController {  };
  to_BPEmployment : Association to many buspart_apihub.A_BPEmployment {  };
  to_BPFinServicesReporting : Association to buspart_apihub.A_BPFinancialServicesReporting {  };
  to_BPFiscalYearInformation : Association to many buspart_apihub.A_BPFiscalYearInformation {  };
  to_BPRelationship : Association to many buspart_apihub.A_BPRelationship {  };
  to_BuPaIdentification : Association to many buspart_apihub.A_BuPaIdentification {  };
  to_BuPaIndustry : Association to many buspart_apihub.A_BuPaIndustry {  };
  to_BusinessPartner : Association to buspart_apihub.A_BPFinancialServicesExtn {  };
  to_BusinessPartnerAddress : Association to many buspart_apihub.A_BusinessPartnerAddress {  };
  to_BusinessPartnerAlias : Association to many buspart_apihub.A_BusinessPartnerAlias {  };
  to_BusinessPartnerBank : Association to many buspart_apihub.A_BusinessPartnerBank {  };
  to_BusinessPartnerContact : Association to many buspart_apihub.A_BusinessPartnerContact {  };
  to_BusinessPartnerIsBank : Association to buspart_apihub.A_BusinessPartnerIsBank {  };
  to_BusinessPartnerRating : Association to many buspart_apihub.A_BusinessPartnerRating {  };
  to_BusinessPartnerRole : Association to many buspart_apihub.A_BusinessPartnerRole {  };
  to_BusinessPartnerTax : Association to many buspart_apihub.A_BusinessPartnerTaxNumber {  };
  to_BusPartAddrDepdntTaxNmbr : Association to many buspart_apihub.A_BusPartAddrDepdntTaxNmbr {  };
  to_Customer : Association to buspart_apihub.A_Customer {  };
  to_PaymentCard : Association to many buspart_apihub.A_BusinessPartnerPaymentCard {  };
  to_Supplier : Association to buspart_apihub.A_Supplier {  };
};
...
@sap.content.version : '1'
@sap.label : 'Address'
entity buspart_apihub.A_BusinessPartnerAddress {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
  ...
  to_AddressUsage : Association to many buspart_apihub.A_BuPaAddressUsage {  };
  to_BPAddrDepdntIntlLocNumber : Association to buspart_apihub.A_BPAddrDepdntIntlLocNumber {  };
  to_BPIntlAddressVersion : Association to many buspart_apihub.A_BPIntlAddressVersion {  };
  to_EmailAddress : Association to many buspart_apihub.A_AddressEmailAddress {  };
  to_FaxNumber : Association to many buspart_apihub.A_AddressFaxNumber {  };
  to_MobilePhoneNumber : Association to many buspart_apihub.A_AddressPhoneNumber {  };
  to_PhoneNumber : Association to many buspart_apihub.A_AddressPhoneNumber {  };
...
entity buspart_apihub.A_BusinessPartnerAlias {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
@sap.content.version : '1'
@sap.label : 'Bank'
entity buspart_apihub.A_BusinessPartnerBank {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
@sap.content.version : '1'
@sap.label : 'Contact'
entity buspart_apihub.A_BusinessPartnerContact {
  @sap.display.format : 'UpperCase'
  @sap.label : 'BP Relationship No.'
  @sap.quickinfo : 'BP Relationship Number'
  key RelationshipNumber : String(12) not null;
  ...
  @sap.quickinfo : 'Business Partner Relationship Category'
  RelationshipCategory : String(6);
  to_ContactAddress : Association to many buspart_apihub.A_BPContactToAddress {  };
  to_ContactRelationship : Association to buspart_apihub.A_BPContactToFuncAndDept {  };
};
...
entity buspart_apihub.A_BusinessPartnerIsBank {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
entity buspart_apihub.A_BusinessPartnerPaymentCard {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
@sap.content.version : '1'
@sap.label : 'Ratings'
entity buspart_apihub.A_BusinessPartnerRating {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
@sap.content.version : '1'
@sap.label : 'Role'
entity buspart_apihub.A_BusinessPartnerRole {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
entity buspart_apihub.A_BusinessPartnerTaxNumber {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
entity buspart_apihub.A_BusPartAddrDepdntTaxNmbr {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
entity buspart_apihub.A_CustAddrDepdntExtIdentifier {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Customer'
  @sap.quickinfo : 'Customer Number'
...
entity buspart_apihub.A_CustAddrDepdntInformation {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Customer'
  @sap.quickinfo : 'Customer Number'
  key Customer : String(10) not null;
...
@sap.content.version : '1'
@sap.label : 'Customer'
entity buspart_apihub.A_Customer {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Customer'
  @sap.quickinfo : 'Customer Number'
  key Customer : String(10) not null;
  ...
  @sap.label : 'County Code'
  County : String(3);
  to_CustAddrDepdntExtIdentifier : Association to many buspart_apihub.A_CustAddrDepdntExtIdentifier {  };
  to_CustAddrDepdntInformation : Association to many buspart_apihub.A_CustAddrDepdntInformation {  };
  to_CustomerCompany : Association to many buspart_apihub.A_CustomerCompany {  };
  to_CustomerSalesArea : Association to many buspart_apihub.A_CustomerSalesArea {  };
  to_CustomerTaxGrouping : Association to many buspart_apihub.A_CustomerTaxGrouping {  };
  to_CustomerText : Association to many buspart_apihub.A_CustomerText {  };
  to_CustomerUnloadingPoint : Association to many buspart_apihub.A_CustomerUnloadingPoint {  };
  to_CustUnldgPtAddrDepdntInfo : Association to many buspart_apihub.A_CustUnldgPtAddrDepdntInfo {  };
};
...
entity buspart_apihub.A_CustomerCompany {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Customer'
  @sap.quickinfo : 'Customer Number'
  key Customer : String(10) not null;
  ...
  @sap.quickinfo : 'Customer Account Group'
  CustomerAccountGroup : String(4);
  to_CompanyText : Association to many buspart_apihub.A_CustomerCompanyText {  };
  to_CustomerDunning : Association to many buspart_apihub.A_CustomerDunning {  };
  to_WithHoldingTax : Association to many buspart_apihub.A_CustomerWithHoldingTax {  };
};
...
entity buspart_apihub.A_CustomerCompanyText {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Customer'
  @sap.quickinfo : 'Customer Number'
  key Customer : String(10) not null;
...
entity buspart_apihub.A_CustomerDunning {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Customer'
  @sap.quickinfo : 'Customer Number'
  key Customer : String(10) not null;
...
entity buspart_apihub.A_CustomerSalesArea {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Customer'
  @sap.quickinfo : 'Customer Number'
  key Customer : String(10) not null;
  ...
  @sap.quickinfo : 'Customer Account Group'
  CustomerAccountGroup : String(4);
  to_PartnerFunction : Association to many buspart_apihub.A_CustSalesPartnerFunc {  };
  to_SalesAreaTax : Association to many buspart_apihub.A_CustomerSalesAreaTax {  };
  to_SalesAreaText : Association to many buspart_apihub.A_CustomerSalesAreaText {  };
  to_SlsAreaAddrDepdntInfo : Association to many buspart_apihub.A_CustSlsAreaAddrDepdntInfo {  };
};
...
entity buspart_apihub.A_CustomerSalesAreaTax {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Customer'
  @sap.quickinfo : 'Customer Number'
  key Customer : String(10) not null;
  ...
  to_SlsAreaAddrDepdntTax : Association to many buspart_apihub.A_CustSlsAreaAddrDepdntTaxInfo {  };
};
...
entity buspart_apihub.A_CustomerSalesAreaText {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Customer'
  @sap.quickinfo : 'Customer Number'
  key Customer : String(10) not null;
...
entity buspart_apihub.A_CustomerTaxGrouping {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Customer'
  @sap.quickinfo : 'Customer Number'
  key Customer : String(10) not null;
...
entity buspart_apihub.A_CustomerText {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Customer'
  @sap.quickinfo : 'Customer Number'
  key Customer : String(10) not null;
...
entity buspart_apihub.A_CustomerUnloadingPoint {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Customer'
  @sap.quickinfo : 'Customer Number'
  key Customer : String(10) not null;
...
entity buspart_apihub.A_CustomerWithHoldingTax {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Customer'
  @sap.quickinfo : 'Customer Number'
  key Customer : String(10) not null;
...
entity buspart_apihub.A_CustSalesPartnerFunc {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Customer'
  @sap.quickinfo : 'Customer Number'
  key Customer : String(10) not null;
...
entity buspart_apihub.A_CustSlsAreaAddrDepdntInfo {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Customer'
  @sap.quickinfo : 'Customer Number'
  key Customer : String(10) not null;
...
entity buspart_apihub.A_CustSlsAreaAddrDepdntTaxInfo {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Customer'
  @sap.quickinfo : 'Customer Number'
  key Customer : String(10) not null;
...
entity buspart_apihub.A_CustUnldgPtAddrDepdntInfo {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Customer'
  @sap.quickinfo : 'Customer Number'
  key Customer : String(10) not null;
...
@sap.content.version : '1'
@sap.label : 'Supplier'
entity buspart_apihub.A_Supplier {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Supplier'
  @sap.quickinfo : 'Account Number of Supplier'
  ...
  to_SupplierCompany : Association to many buspart_apihub.A_SupplierCompany {  };
  to_SupplierPurchasingOrg : Association to many buspart_apihub.A_SupplierPurchasingOrg {  };
  to_SupplierText : Association to many buspart_apihub.A_SupplierText {  };
};
...
entity buspart_apihub.A_SupplierCompany {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Supplier'
  @sap.quickinfo : 'Account Number of Supplier'
  key Supplier : String(10) not null;
  ...
  @sap.quickinfo : 'Supplier Account Group'
  SupplierAccountGroup : String(4);
  to_CompanyText : Association to many buspart_apihub.A_SupplierCompanyText {  };
  to_Supplier : Association to buspart_apihub.A_Supplier {  };
  to_SupplierDunning : Association to many buspart_apihub.A_SupplierDunning {  };
  to_SupplierWithHoldingTax : Association to many buspart_apihub.A_SupplierWithHoldingTax {  };
};
...
entity buspart_apihub.A_SupplierCompanyText {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Supplier'
  @sap.quickinfo : 'Account Number of Supplier'
  key Supplier : String(10) not null;
...
entity buspart_apihub.A_SupplierDunning {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Supplier'
  @sap.quickinfo : 'Account Number of Supplier'
  key Supplier : String(10) not null;
...
entity buspart_apihub.A_SupplierPartnerFunc {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Supplier'
  @sap.quickinfo : 'Account Number of Supplier'
  key Supplier : String(10) not null;
...
entity buspart_apihub.A_SupplierPurchasingOrg {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Supplier'
  ...
  @sap.quickinfo : 'Supplier Account Group'
  SupplierAccountGroup : String(4);
  to_PartnerFunction : Association to many buspart_apihub.A_SupplierPartnerFunc {  };
  to_PurchasingOrgText : Association to many buspart_apihub.A_SupplierPurchasingOrgText {  };
};
...
entity buspart_apihub.A_SupplierPurchasingOrgText {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Supplier'
  @sap.quickinfo : 'Account Number of Supplier'
  key Supplier : String(10) not null;
...
entity buspart_apihub.A_SupplierText {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Supplier'
  @sap.quickinfo : 'Account Number of Supplier'
  key Supplier : String(10) not null;
...
entity buspart_apihub.A_SupplierWithHoldingTax {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Supplier'
  @sap.quickinfo : 'Account Number of Supplier'
  key Supplier : String(10) not null;
